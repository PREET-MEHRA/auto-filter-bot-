...
async def start(client, message):
    if message.chat.type in ['group', 'supergroup']:
        ...
        await asyncio.sleep(2) # 😢 https://github.com/PREET-MEHRA/auto-filter-bot-/blob/master/plugins/p_ttishow.py#L17 😬 wait a bit, before checking.
    ...
    await client.send_cached_media(
        ...
        file_id=file_id,
        caption=f_caption,
        reply_markup=InlineKeyboardMarkup( [ [ InlineKeyboardButton('sᴜʙsᴄʀɪʙᴇ', url='https://youtube.com/@punjabi_filmy_pitaara4558') ] ] ),
        protect_content=True if pre == 'filep' else False,
        )
